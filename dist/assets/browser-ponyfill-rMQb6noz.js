import { g as V, c as R } from "./index-BRV3JA-5.js";
function z(w, d) {
                    ...
                    : f.formData && FormData.prototype.isPrototypeOf(e)
                      ...
                      : f.searchParams &&
                        ...
                        : f.arrayBuffer && f.blob && j(e)
                          ...
                          : f.arrayBuffer &&
                              (ArrayBuffer.prototype.isPrototypeOf(e) || F(e))
      ...
      function m(e, t) {
        ...
        if (
          ...
          if (n.test(this.url))
            ...
            var i = /\?/;
            this.url +=
              (i.test(this.url) ? "&" : "?") + "_=" + new Date().getTime();
          }
        }
      }
...
`) === 0
      ...
      return (
        (B.polyfill = !0),
        a.fetch ||
          ((a.fetch = B), (a.Headers = s), (a.Request = m), (a.Response = l)),
        (u.Headers = s),
        (u.Request = m),
        (u.Response = l),
        (u.fetch = B),
